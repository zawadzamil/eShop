                                ...
                                <div class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span
                                            class="thumb avatar pull-left m-r"> <img
                                                src="{{('../../public/admin/images/a0.png')}}" class="dker"
                                                alt="..."> <i class="on md b-black"></i> </span> <span
                                ...
                                <ul class="nav nav-main" data-ride="collapse">
                                    ...
                                    <li class="">
                                        <a href="{{url('add_product')}}" class="auto"> <i
                                                class="i i-statistics icon"> </i> <span
                                                class="font-bold">Add Products</span> </a>
                                    </li>
                                    <li>
                                        <a href="#" class="auto"> <span class="pull-right text-muted"> <i
                                                ...
                                                class="badge bg-danger pull-right"></b> <i class="i i-stack icon"> </i>
                                            <span class="font-bold">Catagories</span> </a>
                                        <ul class="nav dk">
                                            @php
